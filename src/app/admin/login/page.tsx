...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  NotStaff: 'This account does not have staff access. Sign in with a staff email, or use the public login for client accounts.',
};
...
export default async function AdminLoginPage({
  ...
  // Only staff sessions skip the form. A non-staff session must NOT redirect
  // back to this same URL — that caused ERR_TOO_MANY_REDIRECTS.
